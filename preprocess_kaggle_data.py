...
def preprocess_myntra_data(input_file, output_file, sample_size=100000):
    ...
    print("Enriching with structured columns (type/gender/color/material/fit/pattern)...")
    # 8. Mine product_url + product_name into structured, filterable columns.
    import enrich
    df = enrich.enrich_dataframe(df)

    print(f"Saving to {output_file}...")
    # 9. Save the cleaned + enriched dataset
